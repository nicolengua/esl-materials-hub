...
Rules: don't invent content — only sort what's there. Leave a field as an empty string if nothing applies. Preserve concrete detail (quotes, names, examples) and keep any links/URLs exactly as written, next to the resource they belong to. Return ONLY a JSON object with exactly those seven string keys, no markdown fences, no commentary.`;
