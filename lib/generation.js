...
- correction_grid: { title, intro?, rows:[{you, instead, why}] }. The workhorse: what the student said / what to say instead / why (tie the why to their L1). Lead with this when there are spoken errors. The app automatically wraps "you" in quotes and bolds "instead" — put plain text in those fields, no added quotation marks or **asterisks**.
