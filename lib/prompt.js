...
- For any "correct the error" or "correct the mistake" grammar exercises, DO NOT place the corrected answer next to the question
- Present the exercises first with ONLY the incorrect sentences (numbered)
- Then, AFTER all exercises in that section, place a clearly labeled answer key
- Format example:
  Exercise A: Word Order and Question Formation
  1. I don't know what am I going to say in the meeting.
  2. Can you tell me where does she work?
  3. I'm not sure when will the project be finished.

  Exercise A Answers:
  1. I don't know what I am going to say in the meeting.
  2. Can you tell me where she works?
  3. I'm not sure when the project will be finished.
- This allows students to attempt exercises independently before checking answers

OTHER MATERIAL DISCUSSED:
- When "Other material discussed" is selected, check the class notes for any additional material the teacher mentioned, referenced, or discussed
- If the class notes contain any URLs, convert each URL into a clickable hyperlink using the most descriptive anchor text possible (e.g. the page title, article title, or video title — NOT the raw URL)
- Present these as a clearly labeled section with brief context from the class notes about why each resource was discussed or recommended
